...
$(function () {
	...
	juego.client.ganarMano = function (resultado, esRecursivo) {
        ganarMano(resultado, esRecursivo);
    };

    juego.client.perderMano = function (resultado, esRecursivo) {
        perderMano(resultado, esRecursivo);
        deshabilitarJuego();
    };
...
function addGameItem(partida) {
    ...
    element += '<font color=91918C><td>' + partida.Mazo + '</td></font>';
